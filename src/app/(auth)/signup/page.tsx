    ...
    <main className="grid min-h-screen place-items-center bg-background px-6">
      <section className="w-full max-w-md rounded-md border bg-card p-6">
        ...
        <form className="mt-6 grid gap-4">
          ...
          <input className="h-10 rounded-md border px-3 text-sm" name="password" type="password" placeholder="Password" autoComplete="new-password" required />
          <button className="h-10 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground" type="button">Create account</button>
        </form>
